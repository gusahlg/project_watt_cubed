...
as much customization as possible and there should be few limitations for what things you can make of the gameplay. Community represents the
...
# Code Philosophy
The code must always be very modular and may heavily use macros and generics to achieve minimal repetition. An important part is that the code
...
works with naming conventions and conveys purpose in a clear and non-contradictory way. The comment style is conservative, write overall purpose
...
important part of the code philosophy is that optimization and efficiency always goes ahead of readability and ease. It is essential that the code
