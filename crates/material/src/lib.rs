...
pub use kernel::{element_influence, interact, Delta, ReactionResult};
pub use law::{Boundary, EventKind, EventStrengths, Kernel, Law, LawError, Probes, EVENT_KINDS, KNOTS};
