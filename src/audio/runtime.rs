...
use super::backend::{Backend, BackendVoice, ClipId, ClipStore};
use super::content::{Catalog, CatalogError, CueId, CueSymbols, DrawKind, Layer, Loop, OneShot, draw, draw_raw};
use super::frame::{AudioFrame, Emitter, EmitterId, Occurrence, OccurrenceId};
use super::voice::{Epoch, PACKET_QUEUE_DEPTH, Session, SessionKey, VoicePacket};
...
mod seam_tests {
    ...
    use super::super::content::{Catalog, CueSymbols, Loop, OneShot};
    use super::super::frame::{AudioFrame, Emitter, EmitterId, Occurrence, OccurrenceId};
    use super::super::voice::{Epoch, Seq, SessionKey, VoicePacket};
    use super::super::assets::SoundConfig;
    use super::{MixChange, SoundSystem};
