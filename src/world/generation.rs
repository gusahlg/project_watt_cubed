...
mod tests {
    ...
    fn chunk_byte_pin() {
        ...
        let pins: [(&str, i32, i32, i32, u32); 8] = [
            ("surface", 0, 1, 0, 0x117e0b49),
            ("deep", 0, -20, 0, 0xf49aaa06),
            ("cave", 0, -3, 0, 0x8bb7977c),
            ("island", -1, 9, -4, 0xa7eba1c0),
            ("beach", 4, 0, -7, 0x7e0d8ea7),
            ("crust", 55, 1, -80, 0x0c7d2c5c),
            ("far_a", 6_250_000, 0, 0, 0x0022d643),
            ("far_b", -6_250_000, -2, 3, 0x1624b50f),
        ];
